        ...
        try:
            ...
            for event in events:
                formatted_event = {
                    ...
                    'eventType': 'other'  # Default Google events to 'other'
                }
...
@events_bp.get("/test-sleep-toggles")
def test_sleep_toggles():
    """Test page for sleep toggles functionality."""
    logger.info("Sleep toggles test page requested")
    return render_template('test_sleep_toggles.html')

@events_bp.get("/test-filtering")
def test_filtering():
    """Test page for event filtering functionality."""
